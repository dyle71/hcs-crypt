...
#ifndef HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_OPENSSL_AES_192_CBC_ENCRYPTOR_HPP
#define HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_OPENSSL_AES_192_CBC_ENCRYPTOR_HPP
...
/**
 * @brief   The OpenSSL AES 192 Bit Cypher CBC Encryptor.
 */
class OpenSSLAES192CBCEncrypter : public OpenSSLSymmetricCipher {

public:
    /**
     * @brief   Constructor
     */
    OpenSSLAES192CBCEncrypter() : OpenSSLSymmetricCipher(true) {
    }
