...
#ifndef HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_256_ECB_ENCRYPTOR_HPP
#define HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_256_ECB_ENCRYPTOR_HPP
...
/**
 * @brief   The LibTomCrypt AES 256 Bit Cypher ECB Encryptor.
 */
class LTCAES256ECBEncrypter : public LTCSymmetricECBCipher {
