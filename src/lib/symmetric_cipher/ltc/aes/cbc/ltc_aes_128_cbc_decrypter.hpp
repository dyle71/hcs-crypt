...
#ifndef HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_128_CBC_DECRYPTOR_HPP
#define HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_128_CBC_DECRYPTOR_HPP
...
/**
 * @brief   The LibTomCrypt AES 128 Bit Cypher CBC Decryptor.
 */
class LTCAES128CBCDecrypter : public LTCSymmetricCBCCipher {
