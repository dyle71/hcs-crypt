...
#ifndef HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_192_CBC_ENCRYPTOR_HPP
#define HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_192_CBC_ENCRYPTOR_HPP
...
/**
 * @brief   The LibTomCrypt AES 192 Bit Cypher CBC Encryptor.
 */
class LTCAES192CBCEncrypter : public LTCSymmetricCBCCipher {
