...
#ifndef HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_256_CBC_DECRYPTOR_HPP
#define HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_256_CBC_DECRYPTOR_HPP
...
/**
 * @brief   The LibTomCrypt AES 256 Bit Cypher CBC Decryptor.
 */
class LTCAES256CBCDecrypter : public LTCSymmetricCBCCipher {
