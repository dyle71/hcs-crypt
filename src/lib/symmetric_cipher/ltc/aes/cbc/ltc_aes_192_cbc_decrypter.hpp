...
#ifndef HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_192_CBC_DECRYPTOR_HPP
#define HEADCODE_SPACE_CRYPT_CYPHER_SYMMTERIC_LTC_AES_192_CBC_DECRYPTOR_HPP
...
/**
 * @brief   The LibTomCrypt AES 192 Bit Cypher CBC Decryptor.
 */
class LTCAES192CBCDecrypter : public LTCSymmetricCBCCipher {
