...
#ifndef HEADCODE_SPACE_CRYPT_HASH_OPENSSL_SHA384_HPP
#define HEADCODE_SPACE_CRYPT_HASH_OPENSSL_SHA384_HPP
...
/**
 * @brief   The OpenSSL SHA384 hash.
 */
class OpenSSLSHA384 : public Algorithm {
