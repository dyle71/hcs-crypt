...
#ifndef HEADCODE_SPACE_CRYPT_HASH_OPENSSL_SHA1_HPP
#define HEADCODE_SPACE_CRYPT_HASH_OPENSSL_SHA1_HPP
...
/**
 * @brief   The OpenSSL SHA1 hash.
 */
class OpenSSLSHA1 : public Algorithm {

    SHA_CTX sha_ctx_;        //!< @brief The OpenSSL SHA context used.
