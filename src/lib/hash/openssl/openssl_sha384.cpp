...
int OpenSSLSHA384::Add_(char const * block_incoming,
...
int OpenSSLSHA384::Finalize_(char * result, std::uint64_t, char const * , std::uint64_t) {
    return SHA384_Final(reinterpret_cast<unsigned char *>(result), &sha_ctx_) == 1 ? 0 : 1;
}
