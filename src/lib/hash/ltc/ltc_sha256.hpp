...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_SHA256_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_SHA256_HPP
...
/**
 * @brief   The libtomcrypt SHA256 algorithm.
 */
class LTCSHA256 : public LTCHash {
