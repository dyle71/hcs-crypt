...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_RIPEMD160_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_RIPEMD160_HPP
...
/**
 * @brief   The libtomcrypt RIPEMD160 algorithm.
 */
class LTCRIPEMD160 : public LTCHash {
