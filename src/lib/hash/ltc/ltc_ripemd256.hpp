...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_RIPEMD256_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_RIPEMD256_HPP
...
/**
 * @brief   The libtomcrypt RIPEMD256 algorithm.
 */
class LTCRIPEMD256 : public LTCHash {
