...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_TIGER192_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_TIGER192_HPP
...
/**
 * @brief   The libtomcrypt TIGER192 algorithm.
 */
class LTCTIGER192 : public LTCHash {
