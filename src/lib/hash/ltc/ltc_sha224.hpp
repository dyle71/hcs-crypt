...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_SHA224_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_SHA224_HPP
...
/**
 * @brief   The libtomcrypt SHA224 algorithm.
 */
class LTCSHA224 : public LTCHash {
