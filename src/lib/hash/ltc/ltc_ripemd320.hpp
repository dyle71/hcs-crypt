...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_RIPEMD320_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_RIPEMD320_HPP
...
/**
 * @brief   The libtomcrypt RIPEMD320 algorithm.
 */
class LTCRIPEMD320 : public LTCHash {
