...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_SHA1_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_SHA1_HPP
...
/**
 * @brief   The libtomcrypt SHA1 algorithm.
 */
class LTCSHA1 : public LTCHash {
