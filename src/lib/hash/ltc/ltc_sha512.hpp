...
#ifndef HEADCODE_SPACE_CRYPT_HASH_LTC_SHA512_HPP
#define HEADCODE_SPACE_CRYPT_HASH_LTC_SHA512_HPP
...
/**
 * @brief   The libtomcrypt SHA512 algorithm.
 */
class LTCSHA512 : public LTCHash {
