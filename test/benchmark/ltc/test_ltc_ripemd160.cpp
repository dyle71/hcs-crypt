...
TEST(Benchmark_LTCRIPEMD160, LTCRIPEMD160StdString1000) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkLTCRIPEMD160::LTCRIPEMD160StdString1000 ");
...
TEST(Benchmark_LTCRIPEMD160, LTCRIPEMD160CArray1000) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkLTCRIPEMD160::LTCRIPEMD160CArray1000 ");
