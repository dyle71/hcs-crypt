...
TEST(Benchmark_OPENSSLAES128ECB, OPENSSLAES128ECBString) {

    auto loop_count = 100'000u;

    auto algo = headcode::crypt::Factory::Create("openssl-aes-128-ecb-encryptor");
    ASSERT_NE(algo.get(), nullptr);
    EXPECT_STREQ(algo->GetDescription().name_.c_str(), "openssl-aes-128-ecb-encryptor");
    ...
    std::cout << StreamPerformanceIndicators(throughput,
                                             "Benchmark Benchmark_OPENSSLAES128ECB::OPENSSLAES128ECBString ");
}


TEST(Benchmark_OPENSSLAES128ECB, OPENSSLAES128ECBCArray) {
    ...
    std::cout << StreamPerformanceIndicators(throughput,
                                             "Benchmark Benchmark_OPENSSLAES128ECB::OPENSSLAES128ECBCArray ");
}
