...
TEST(Benchmark_OPENSSLSHA224, OPENSSLSHA224StdString1000) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkOPENSSLSHA224::OPENSSLSHA224StdString1000 ");
...
TEST(Benchmark_OPENSSLSHA224, OPENSSLSHA224CArray1000) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkOPENSSLSHA224::OPENSSLSHA224CArray1000 ");
