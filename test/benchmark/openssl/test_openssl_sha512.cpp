...
TEST(Benchmark_OPENSSLSHA512, OPENSSLSHA512StdString1000) {

    auto loop_count = 100'000u;

    auto algo = headcode::crypt::Factory::Create("openssl-sha512");
    ASSERT_NE(algo.get(), nullptr);
    EXPECT_STREQ(algo->GetDescription().name_.c_str(), "openssl-sha512");
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkOPENSSLSHA512::OPENSSLSHA512StdString1000 ");
...
TEST(Benchmark_OPENSSLSHA512, OPENSSLSHA512CArray1000) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkOPENSSLSHA512::OPENSSLSHA512CArray1000 ");
