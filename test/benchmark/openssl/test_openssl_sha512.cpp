...
TEST(Benchmark_OPENSSLSHA512, OPENSSLSHA512StdString) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "Benchmark OpenSSLSHA512::OPENSSLSHA512StdString ");
...
TEST(Benchmark_OPENSSLSHA512, OPENSSLSHA512CArray) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "Benchmark OpenSSLSHA512::OPENSSLSHA512CArray ");
