...
TEST(Benchmark_OPENSSLSHA1, OPENSSLSHA1StdString1000) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkOPENSSLSHA1::OPENSSLSHA1StdString1000 ");
...
TEST(Benchmark_OPENSSLSHA1, OPENSSLSHA1CArray1000) {
    ...
    std::cout << StreamPerformanceIndicators(throughput, "BenchmarkOPENSSLSHA1::OPENSSLSHA1CArray1000 ");
