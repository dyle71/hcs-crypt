...
#ifndef HEADCODE_SPACE_CRYPT_TEST_SHARED_IPSUM_LOREM_HPP
#define HEADCODE_SPACE_CRYPT_TEST_SHARED_IPSUM_LOREM_HPP
...
At accusam aliquyam diam diam dolore dolores duo eirmod eos erat, et \n\
nonumy sed tempor et et invidunt justo labore Stet clita ea et gubergren, \n\
kasd magna no rebum. sanctus sea sed takimata ut vero voluptua. est Lorem \n\
